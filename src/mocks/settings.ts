...
export let mockTeam: TeamMember[] = [
  { id: 'TM-001', name: 'Sarah Osei', email: 'sarah@yourcompany.com', role: 'owner', status: 'active', lastActiveAt: new Date(Date.now() - 1800000).toISOString(), invitedAt: '2025-10-01T10:00:00Z' },
  { id: 'TM-002', name: 'Kweku Amponsah', email: 'kweku@yourcompany.com', role: 'admin', status: 'active', lastActiveAt: new Date(Date.now() - 86400000).toISOString(), invitedAt: '2025-10-05T10:00:00Z' },
  { id: 'TM-003', name: 'Amara Diallo', email: 'amara@yourcompany.com', role: 'reviewer', status: 'active', lastActiveAt: new Date(Date.now() - 86400000 * 2).toISOString(), invitedAt: '2025-11-15T10:00:00Z' },
  { id: 'TM-004', name: 'Ngozi Williams', email: 'ngozi@yourcompany.com', role: 'viewer', status: 'invited', invitedAt: new Date(Date.now() - 86400000 * 3).toISOString() },
];
